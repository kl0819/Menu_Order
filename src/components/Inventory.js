...
class Inventory extends Component {
  ...
  handleChange = (e, key) => {
    ...
    // Take copy of fish & update it with new data
    const updatedFish = {...fish, 
      [e.target.name]: e.target.value // computed property
    };
    // Pass to updateFish function on the App component 
  ...
  authHandler = (err, authData) => {
    ...
    // query firebase databse once for the store data
  ...
  render() {
    ...
    // Check if owner of current owner
